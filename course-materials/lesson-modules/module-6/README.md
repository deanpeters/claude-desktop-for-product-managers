...
One big bundle — messaging, development, deployment, and GTM planning. The product the learner has carried since Module 2 finally leaves the building, and every Claude Desktop element from Modules 0–5 gets used in anger.

## Lessons

- `6.1-from-positioning-to-messaging/` — message house and value props per persona
- `6.2-the-launch-narrative/` — announcement copy that survives skeptics
