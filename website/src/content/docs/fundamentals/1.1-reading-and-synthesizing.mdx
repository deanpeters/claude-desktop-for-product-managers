...
The full lesson (objective, why and when, files, prompts, checklist, extension) is `course-materials/lesson-modules/module-1/1.1-reading-and-synthesizing/LESSON.md`.
